	    ...
	    public static SessionFactory getSessionFactory() {
	        if (sessionFactory == null) {
	            try {
	                ...
	                settings.put(Environment.URL, "jdbc:mysql://localhost:3306/retroRidesDb?createDatabaseIfNotExist=true");
	                settings.put(Environment.USER, "root");
	                settings.put(Environment.PASS, "Friends_1306");
	                ...
	                configuration.addAnnotatedClass(BidDetails.class);
