...
<div class="container">
	...
	<!-- update Vehicle Details Form -->
		...
		<form:form action="${contextPath}/admin/updateVehicleDetails" method="post" modelAttribute="vehicleDetail">
		<div class="row">
			<div class="col-md-4 col-md-offset-4">
				<table class="table">
					...
					<tr>
						<td>Mileage:</td>
						<td>${vehicleDetail.getMileage()}</td>
					</tr>
					<tr>
					...
					<tr>
						<td>Color:</td>
						<td>${vehicleDetail.getColor()}</td>
					</tr>
					<tr>
						<td>State:</td>
						<td>
							${vehicleDetail.getState()}
						</td>
					</tr>
		...
		<div class="row">
			<div class="col-md-12 text-center">
				<input type="submit" class="btn btn-primary" name=action value="Update Status" />
